...
// Icons: you can keep lucide-react or replace with SVG. We'll keep them but ensure lucide-react is installed.
...
const Login = () => {
  ...
  // Password strength (optional, but safe)
          ...
          <div className="hidden md:flex flex-col space-y-6 p-8">
            ...
            <div className="space-y-4 mt-8">
              <div className="flex items-center space-x-3">
                ...
                <div><p className="font-semibold text-gray-900">Secure & Private</p><p className="text-sm text-gray-600">Your data is encrypted and safe</p></div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div><p className="font-semibold text-gray-900">24/7 Access</p><p className="text-sm text-gray-600">Access your notes anytime, anywhere</p></div>
              </div>
            </div>
          </div>

          {/* Login Card – using plain div with Tailwind (no shadcn) */}
          <div className="w-full bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border-0">
            <div className="py-6 text-center">
              <h2 className="text-3xl font-semibold text-gray-900 tracking-wide">Sign In</h2>
            ...
            <form onSubmit={handleSubmit}>
              <div className="px-6 py-8 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full pl-10 pr-3 py-2 border-2 rounded-lg focus:outline-none focus:ring-2 ${
                        fieldErrors.email
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onKeyUp={handleKeyUp}
                      placeholder="Enter your password"
                      className={`w-full pr-12 pl-3 py-2 border-2 rounded-lg focus:outline-none focus:ring-2 ${
                  ...
                  {formData.password && !fieldErrors.password && (
                    <div className="space-y-1 mt-2">
                      ...
                      <p className="text-xs text-gray-600">Password strength: <span className="font-semibold">{passwordStrength.text}</span></p>
                    </div>
                  )}
                  {fieldErrors.password && (
                    <div className="flex items-center gap-1 text-red-500 text-sm mt-1">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button type="button" onClick={() => handleSocialLogin('Google')} className="flex items-center justify-center gap-2 w-full py-2 border border-gray-200 rounded-lg hover:bg-gray-50 transition-all">
                    <Chrome className="w-4 h-4" /> Google
                  </button>
                  <button type="button" onClick={() => handleSocialLogin('GitHub')} className="flex items-center justify-center gap-2 w-full py-2 border border-gray-200 rounded-lg hover:bg-gray-50 transition-all">
              ...
              <div className="px-6 py-6 flex flex-col gap-4">
                <button
                  ...
                  className="w-full bg-black hover:bg-gray-800 text-white font-semibold py-3 rounded-lg flex justify-center items-center gap-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
