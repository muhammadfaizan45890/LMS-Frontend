...
const ActiveCourses = () => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-zinc-50 via-white to-zinc-50 overflow-x-hidden">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-black via-zinc-900 to-black text-white">
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-full blur-[100px]" />
            <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-gradient-to-r from-cyan-500/20 to-emerald-500/20 rounded-full blur-[100px]" />
          ...
          <div className="relative px-4 sm:px-6 lg:px-10 py-8 lg:py-14">
            ...
            <div className="mt-10 flex flex-col xl:flex-row gap-10 items-start justify-between">
              <div className="max-w-4xl">
                ...
                <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-white/20 to-white/10 flex items-center justify-center mb-6 backdrop-blur-md shadow-xl">
              ...
              {/* COURSE STATS CARD */}
              <div className="w-full xl:w-[380px] bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-6 shadow-2xl">
        ...
        <div className="px-4 sm:px-6 lg:px-10 py-8 lg:py-12">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
            ...
            {/* PROGRESS CARD */}
            <div className="bg-white border border-zinc-200 rounded-2xl px-6 py-3 shadow-lg">
          ...
          {progress === 100 && courses.length > 1 && (
            <div className="mt-10 p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-3xl border border-purple-200">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 via-white to-zinc-50 overflow-x-hidden">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-black via-zinc-900 to-black text-white">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-full blur-[120px]" />
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-gradient-to-r from-cyan-500/20 to-emerald-500/20 rounded-full blur-[100px]" />
      ...
      <div className="px-4 sm:px-6 lg:px-10 py-10 lg:py-14">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-3xl border border-zinc-200 p-12 lg:p-20 text-center shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-8">
            {courses.map((item, index) => {
              ...
              return (
                <div
                  key={item._id}
                  className="group relative overflow-hidden rounded-3xl border border-zinc-200/80 bg-white shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
                >
                  {/* Top Gradient Bar */}
