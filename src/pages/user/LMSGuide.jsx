  ...
  return (
    <div className="min-h-screen bg-zinc-100 overflow-x-hidden">
      ...
      <section className="relative bg-black text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 py-16 sm:py-20 md:py-24">

          <div className="flex items-center gap-3 mb-4 sm:mb-6">
            <Sparkles className="w-5 h-5" />
            <span className="text-xs sm:text-sm tracking-widest uppercase text-zinc-300">
              LMS Guide
            </span>
          </div>
          ...
          <p className="mt-5 sm:mt-6 text-sm sm:text-base lg:text-lg text-zinc-300 max-w-2xl leading-relaxed">
            A complete guide to understand courses, video learning,
            secure access, and payment process with WhatsApp verification.
          </p>
        </div>
      ...
      {/* CONTENT */}
      <section className="px-3 sm:px-6 lg:px-10 py-10 sm:py-14 lg:py-20">
        <div className="max-w-5xl mx-auto">

          <div className="bg-white rounded-3xl sm:rounded-[40px] p-5 sm:p-8 md:p-10 lg:p-12 shadow-xl border border-zinc-200 space-y-8 sm:space-y-10">

            {/* ICON */}
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl sm:rounded-3xl bg-black text-white flex items-center justify-center shadow-lg">
              <GraduationCap size={32} />
            </div>

            {/* CONTENT */}
            <div className="space-y-6 text-zinc-700 text-base sm:text-lg leading-relaxed sm:leading-[2]">
              ...
              {/* PAYMENT SECTION */}
              <div className="bg-gradient-to-r from-black to-zinc-800 text-white rounded-3xl sm:rounded-[35px] p-5 sm:p-8 lg:p-10 space-y-6">
                ...
                <div className="bg-white/10 border border-white/20 rounded-2xl p-4 sm:p-5">
                  ...
                  <p className="text-lg sm:text-2xl font-bold tracking-wider break-all">
                    {paymentNumber}
                  </p>
                ...
                <div className="bg-white/10 border border-white/20 rounded-2xl p-4 sm:p-5 space-y-3">
                  ...
                  <div className="mt-3 text-xs sm:text-sm bg-black/30 p-3 rounded-xl overflow-x-auto">
                    Example:
                    <br />
                    Name: Ali Khan
                    <br />
              ...
              {/* FINAL */}
              <div className="bg-black text-white rounded-3xl sm:rounded-[35px] p-5 sm:p-8 lg:p-10">
