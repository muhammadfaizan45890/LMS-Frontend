...
const UserDashboard = () => {
  ...
  return (
    // Main container with navbar offset and overflow prevention
    <div className="min-h-screen bg-zinc-100 overflow-x-hidden pt-14 sm:pt-16">
      ...
      <div className="relative overflow-hidden bg-black text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-10 sm:py-12 lg:py-16">
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-8 lg:gap-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 w-full xl:max-w-2xl">
              {/* Total Courses */}
              <div className="bg-white/10 backdrop-blur-xl border border-white/10 rounded-2xl sm:rounded-3xl p-5 sm:p-6">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-8 sm:py-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5 mb-8 sm:mb-10">
          ...
          {/* SEARCH BAR - full width on mobile, fixed on large screens */}
          <div className="relative w-full lg:w-[380px]">
            <Search
              size={20}
              className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400"
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-7">
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <div
                key={item}
                className="bg-white rounded-2xl sm:rounded-[30px] p-5 sm:p-6 shadow-sm border border-zinc-200 animate-pulse"
              >
                <div className="flex items-center justify-between mb-5 sm:mb-6">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 bg-zinc-200 rounded-xl sm:rounded-2xl" />
                  <div className="w-20 h-8 bg-zinc-200 rounded-full" />
                </div>
                <div className="h-6 sm:h-7 bg-zinc-200 rounded mb-3 sm:mb-4" />
                <div className="h-4 bg-zinc-200 rounded mb-2" />
                <div className="h-4 bg-zinc-200 rounded mb-2" />
                <div className="h-4 bg-zinc-200 rounded w-2/3 mb-6 sm:mb-8" />
                <div className="h-10 sm:h-12 bg-zinc-300 rounded-xl sm:rounded-2xl" />
              </div>
            ))}
          </div>
        ) : filteredCourses.length === 0 ? (
            ...
            {filteredCourses.map((course) => {
              ...
              return (
                <div
                  key={course._id}
                  className="
                    group bg-white rounded-2xl sm:rounded-[35px]
                    border border-zinc-200 p-5 sm:p-7
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-5 sm:mb-6">
                    ...
                    {enrollment && (
                      <span
                        className={`
                          px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-[10px] sm:text-xs
                  ...
                  {/* DESCRIPTION */}
                  <p className="text-zinc-600 mt-3 sm:mt-4 leading-relaxed flex-grow text-sm sm:text-base">
                    {course.description}
                  </p>
                  ...
                  {enrollment ? (
                    <button
                      disabled
                      className={`
                        mt-6 sm:mt-8 w-full py-3 sm:py-4 rounded-xl sm:rounded-2xl
                        font-bold cursor-not-allowed text-sm sm:text-base
                        ${
                          enrollment.status === "active"
                            ? "bg-green-600 text-white"
                            : enrollment.status === "pending"
                    ...
                    <button
                      onClick={() => setSelectedCourse(course)}
                      className="
                        mt-6 sm:mt-8 w-full bg-black text-white
                        py-3 sm:py-4 rounded-xl sm:rounded-2xl
                        font-bold hover:bg-zinc-800
                        transition-all duration-300
                        flex items-center justify-center gap-2
                        group-hover:scale-[1.02] text-sm sm:text-base
                      "
                    >
                      Enroll Now
