...
const UserDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-100 pt-14 sm:pt-16 overflow-x-hidden">
      {/* ================= HERO SECTION ================= */}
      <div className="relative overflow-hidden bg-black text-white">
        {/* Glows */}
        <div className="absolute top-0 left-0 w-72 sm:w-96 h-72 sm:h-96 bg-white/10 blur-[120px] rounded-full" />
        <div className="absolute bottom-0 right-0 w-72 sm:w-96 h-72 sm:h-96 bg-white/10 blur-[120px] rounded-full" />

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6 lg:gap-10">
            {/* LEFT TEXT */}
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 bg-white/10 border border-white/10 backdrop-blur-md rounded-full px-3 py-1 sm:px-5 sm:py-2 text-xs sm:text-sm font-semibold mb-4 sm:mb-6">
              ...
              <p className="text-zinc-300 mt-3 sm:mt-6 text-sm sm:text-lg leading-relaxed max-w-2xl">
                Explore premium courses, watch secure lectures,
                track progress, and build your future with
                our powerful LMS learning platform.
              </p>
            ...
            {/* STATS CARDS – 2 columns on small screens, 3 on tablet+ */}
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-5 w-full xl:max-w-2xl">
              {/* Total */}
              <div className="bg-white/10 backdrop-blur-xl border border-white/10 rounded-2xl sm:rounded-3xl p-4 sm:p-6">
                <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-white text-black flex items-center justify-center mb-3 sm:mb-5">
                  <Layers3 size={20} className="sm:w-7 sm:h-7" />
                </div>
                <p className="text-zinc-300 text-[11px] sm:text-sm">Total Courses</p>
                <h2 className="text-2xl sm:text-4xl font-black mt-1">{totalCourses}</h2>
              </div>

              {/* Active */}
              <div className="bg-white/10 backdrop-blur-xl border border-white/10 rounded-2xl sm:rounded-3xl p-4 sm:p-6">
                <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-green-500 text-white flex items-center justify-center mb-3 sm:mb-5">
                  <CheckCircle2 size={20} className="sm:w-7 sm:h-7" />
                </div>
                <p className="text-zinc-300 text-[11px] sm:text-sm">Active Courses</p>
                <h2 className="text-2xl sm:text-4xl font-black mt-1">{activeCourses}</h2>
              </div>

              {/* Pending */}
              <div className="bg-white/10 backdrop-blur-xl border border-white/10 rounded-2xl sm:rounded-3xl p-4 sm:p-6 col-span-2 sm:col-span-1">
                <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-yellow-500 text-white flex items-center justify-center mb-3 sm:mb-5">
                  <AlertCircle size={20} className="sm:w-7 sm:h-7" />
                </div>
                <p className="text-zinc-300 text-[11px] sm:text-sm">Pending</p>
                <h2 className="text-2xl sm:text-4xl font-black mt-1">{pendingCourses}</h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        {/* TOP BAR */}
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6 sm:mb-10">
          <div>
        ...
        {/* LOADING SKELETON – also 2 columns on mobile */}
        {loading ? (
          <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-5">
            {[1,2,3,4,5,6].map((item) => (
              <div
                key={item}
                className="bg-white rounded-2xl sm:rounded-3xl p-3 sm:p-5 shadow-sm border border-zinc-200 animate-pulse"
              >
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-14 sm:h-14 bg-zinc-200 rounded-xl sm:rounded-2xl" />
                  <div className="w-14 h-6 sm:w-20 sm:h-7 bg-zinc-200 rounded-full" />
                </div>
                <div className="h-5 sm:h-6 bg-zinc-200 rounded mb-2" />
                <div className="h-3 bg-zinc-200 rounded mb-1" />
                <div className="h-3 bg-zinc-200 rounded mb-1" />
                <div className="h-3 bg-zinc-200 rounded w-2/3 mb-4 sm:mb-6" />
                <div className="h-8 sm:h-10 bg-zinc-300 rounded-xl" />
              </div>
            ))}
          </div>
        ) : filteredCourses.length === 0 ? (
          <div className="bg-white rounded-2xl sm:rounded-3xl p-8 sm:p-14 text-center border border-zinc-200 shadow-sm">
            <div className="w-16 h-16 sm:w-24 sm:h-24 rounded-full bg-zinc-100 flex items-center justify-center mx-auto mb-4 sm:mb-6">
              <BookOpen size={32} className="sm:w-10 sm:h-10 text-zinc-500" />
            </div>
              ...
              return (
                <div
                  ...
                  className="
                    ...
                    border border-zinc-200 p-3 sm:p-5
                ...
                >
                    ...
                    {enrollment && (
                      <span
                        className={`
                          ...
                          rounded-full text-[9px] sm:text-xs
                  ...
                  {/* TITLE */}
                  <h2 className="text-base sm:text-xl md:text-2xl font-black text-black leading-tight line-clamp-2">
                    {course.title}
                  </h2>
                  ...
                  <div className="mt-3 sm:mt-5 space-y-2 sm:space-y-3">
                    <div className="flex items-center gap-2 sm:gap-3 text-zinc-700">
                      <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-lg bg-zinc-100 flex items-center justify-center">
                        <Clock3 size={14} className="sm:w-4 sm:h-4" />
                      </div>
                      <div>
                        <p className="text-[9px] sm:text-xs text-zinc-500">Duration</p>
                        <h4 className="font-bold text-xs sm:text-sm">{course.duration}</h4>
                      </div>
                    </div>
                    <div className="flex items-center gap-2 sm:gap-3 text-zinc-700">
                      <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-lg bg-zinc-100 flex items-center justify-center">
                      ...
                      <div>
                        <p className="text-[9px] sm:text-xs text-zinc-500">Price</p>
                        <h4 className="font-bold text-xs sm:text-sm">{course.price || "Free"}</h4>
                      </div>
                    </div>
                  </div>
                  ...
                  {enrollment ? (
                    <button
                      disabled
                      className={`
                        mt-4 sm:mt-6 w-full py-2 sm:py-3
                        rounded-xl sm:rounded-2xl
                        font-bold cursor-not-allowed text-xs sm:text-sm
                        ${
                          enrollment.status === "active"
                            ? "bg-green-600 text-white"
                            : enrollment.status === "pending"
                    ...
                    <button
                      onClick={() => setSelectedCourse(course)}
                      className="
                        mt-4 sm:mt-6 w-full bg-black text-white
                        py-2 sm:py-3 rounded-xl sm:rounded-2xl
