      ...
      <section className="relative z-10 w-full min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-10 py-20">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            {/* HEADING */}
            <h1 className="mt-8 text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-black leading-tight tracking-tight">
              Intelligent Learning
            ...
            {/* DESCRIPTION */}
            <p className="mt-8 max-w-2xl text-zinc-600 text-base sm:text-lg leading-relaxed">
              Experience a modern AI-powered platform that helps students
              learn smarter, stay organized, and access secure educational
              content with a beautiful and responsive interface designed
              for productivity and growth.
            ...
            {/* TRUST LINE */}
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 mt-10 text-sm text-zinc-500">
            ...
            ">
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  {/* CARD */}
                  <div className="bg-zinc-50 border border-zinc-200 rounded-3xl p-6 transition-all duration-300">
                    <div className="w-14 h-14 rounded-2xl bg-black text-white flex items-center justify-center mb-5">
                      <PlayCircle size={28} />
                    </div>
                    <h3 className="text-xl font-bold">
                  ...
                  {/* CARD */}
                  <div className="bg-black text-white rounded-3xl p-6 sm:col-span-2">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                      <div>
                        <p className="text-zinc-400 text-sm">
                          Platform Status
                      ...
                      <div className="bg-white text-black px-6 py-3 rounded-2xl font-bold w-fit">
                        AI Enabled
                      </div>
                    </div>
                  </div>
