...
const Hero = () => {
  ...
  const dashboardStats = [
    ...
    { label: "Study Time", value: "24h", icon: Clock, change: "+4h", color: "from-black to-zinc-800" },
  ];
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 sm:space-y-8">
            ...
            {user && (
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 sm:gap-4">
                ...
                <div
                  className={`
                    px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-[10px] sm:text-xs font-bold tracking-wider shadow-lg border transition-all duration-300 hover:scale-105
                    ${
                      user.role === "admin"
                        ? "bg-gradient-to-r from-black to-zinc-800 text-white border-black/20 hover:shadow-black/20"
                        : "bg-white/90 text-black border-zinc-200/80 backdrop-blur-sm hover:shadow-lg"
                    }
                  `}
                >
              ...
              <div className="p-5 sm:p-6 md:p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                  {dashboardStats.map((stat, idx) => (
                    <div
                      key={idx}
                      className="group/stat bg-gradient-to-br from-white to-zinc-50 border border-zinc-200 rounded-xl p-3 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-default"
                    >
                ...
                <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-zinc-200/50">
                  ...
                  <div className="w-full h-1.5 sm:h-2 bg-zinc-100 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-gradient-to-r from-black to-zinc-600 rounded-full relative transition-all duration-500 hover:w-[75%] group/progress-bar"
                      style={{ width: '65%' }}
                    >
